...
function WelcomeMessage() {
  ...
  return (
    <S.Container>
     <div>
     Criamos esse site para compartilhar com vocês os detalhes da organização do nosso casamento. <br/> 
     Estamos muito felizes e contamos com a presença de todos no nosso grande dia! <br/><br/>
